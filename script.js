    ...
    <div class="grid md:grid-cols-2 gap-6">
      ...
      <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-2xl">
        <div class="flex items-center justify-between mb-4">
          ...
          <a href="#" onclick="event.preventDefault();alert('Contact Admin dibuka tgl 30 September 2025');" class="shine-btn px-3 py-1 rounded-lg bg-green-500 text-white text-sm font-semibold hover:scale-105 transition">Admin</a>
        </div>
        <p class="text-gray-300 text-sm mb-4">Hubungi admin atau ikuti saluran resmi kami.</p>
        <a href="https://whatsapp.com/channel/0029Vb6W0kvFSAsvm6ozaY36" target="_blank" class="shine-btn block w-full text-center py-2 rounded-lg bg-green-600 text-white font-semibold hover:scale-105 transition">Saluran WA</a>
      </div>
